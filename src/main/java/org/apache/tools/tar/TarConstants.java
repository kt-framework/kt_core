 ...
 *
 * For tar formats (FORMAT_OLDGNU, FORMAT_POSIX, etc.) see GNU tar <I>tar.h</I>
 * type <I>enum archive_format</I>
 */
...
public interface TarConstants {
	...
	/**
	 * The maximum value of gid/uid in a tar archive which can be expressed in
	 * octal char notation (that's 7 sevens, octal).
	 */
	...
	/**
	 * The length of the size field in a header buffer. Includes the trailing
	 * space or NUL.
	 */
	int SIZELEN = 12;

	/**
	 * The maximum size of a file in a tar archive which can be expressed in
	 * octal char notation (that's 11 sevens, octal).
	 */
	...
	/**
	 * Previously this was regarded as part of "magic" field, but it is
	 * separate.
	 */
	int VERSIONLEN = 2;
