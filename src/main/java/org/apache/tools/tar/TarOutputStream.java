...
public class TarOutputStream extends FilterOutputStream {
	...
	/**
	 * star/GNU tar/BSD tar extensions are used to store big number in the
	 * archive.
	 */
	...
	/**
	 * Set the big number mode. This can be BIGNUMBER_ERROR(0),
	...
	private void addPaxHeadersForBigNumbers(Map<String, String> paxHeaders,
		...
		addPaxHeaderForBigNumber(paxHeaders, "gid", entry.getGroupId(),
				TarConstants.MAXID);
		addPaxHeaderForBigNumber(paxHeaders, "mtime", entry.getModTime()
				.getTime() / 1000, TarConstants.MAXSIZE);
	...
	private void addPaxHeaderForBigNumber(Map<String, String> paxHeaders,
			String header, long value, long maxValue) {
	...
	private void failForBigNumbers(TarEntry entry) {
		...
		failForBigNumber("last modification time",
				entry.getModTime().getTime() / 1000, TarConstants.MAXSIZE);
