...
class GifIntHashtable extends Dictionary<Object, Object> implements Cloneable {
	// / The hash table data.
	...
	// capacity.
	// @param initialCapacity the initial number of buckets
	public GifIntHashtable(int initialCapacity) {
	...
	public synchronized Object clone() {
		try {
			GifIntHashtable t = (GifIntHashtable) super.clone();
